 ...
 * Modified：${TODO}
 */
public class XingXingActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private static float angle /*= 360 / (6 - 1) */ = 72f;//每个view之间的夹角
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_xingxing);
        initView();
        initListener();
    }
